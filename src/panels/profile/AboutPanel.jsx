            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1">
                    <div className="flex justify-between">
                        ...
                        <span className="text-xs opacity-60">02/2025 - 11/2025</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-sm font-medium">Magicorn — DevOps Intern</span>
                        <span className="text-xs opacity-60">06/2024 - 02/2025</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-sm font-medium">University of Twente — Project Intern</span>
                        <span className="text-xs opacity-60">06/2023 - 09/2023</span>
                    </div>
                </div>
            </div>
